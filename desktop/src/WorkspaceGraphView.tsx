...
import { fileNodeId, type WorkspaceGraph, type WorkspaceGraphNode } from "./workspace_graph";
...
type Props = { graph: WorkspaceGraph };

export default function WorkspaceGraphView({ graph }: Props) {
    ...
    <section className="graph-card" aria-label="Project map">
      ...
      <div className="graph-layout">
        ...
        <aside className="graph-inspector" aria-label="Selected project map item">
          {selected ? <Inspector node={selected} edges={selectedEdges} /> : (
...
function Inspector({ node, edges }: { node: WorkspaceGraphNode; edges: WorkspaceGraph["edges"] }) {
  return (
    <div>
