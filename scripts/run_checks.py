...
def main(argv: list[str] | None = None) -> int:
    ...
    report = {
        ...
        'deployment_manifest': {
            ...
            'deployment_policy_source': deployment.deployment_policy_source,
            'deployment_policy_hash': deployment.deployment_policy_hash,
            'deployment_registry_source': deployment.deployment_registry_source,
            'deployment_registry_hash': deployment.deployment_registry_hash,
