...
| WASM-001 | Wasmtime 47 migration is security-reviewed | `Cargo.toml`, `WASMTIME_MIGRATION.md`, sandbox tests, `fuzz/` | `PROVEN` exact 47.0.4 configuration/static gates, Rust behavior tests, and retained resource-contract fuzz evidence; broader Wasmtime/adversarial and hostile-kernel evidence `NOT VERIFIED` |
