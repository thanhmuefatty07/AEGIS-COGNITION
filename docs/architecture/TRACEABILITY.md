...
| DEEP-001 | Security, replay, and dependency evidence is retained | `.github/workflows/deep.yml`, `docs/architecture/VERIFICATION_BASELINE.md` | `PROVEN`: full workspace tests/nextest, coverage, cargo-deny/audit, replay/resource benchmark, fuzz, Miri, and AddressSanitizer selected probes passed in [32778232964](https://github.com/thanhmuefatty07/AEGIS-COGNITION/actions/runs/32778232964) |
...
| REL-001 | Release wheel hashes, SBOM, and provenance path | `scripts/release_evidence.py`, `.github/workflows/release.yml` | `PROVEN`: wheel build, payload verification, SBOM, metadata, and artifact upload passed in [32779649368](https://github.com/thanhmuefatty07/AEGIS-COGNITION/actions/runs/32779649368); GitHub attestation persistence is unavailable for this user-owned private repository |
