...
| CI-001 | CI runs the resolved environment | `.github/workflows/ci.yml`, `.github/workflows/deep.yml` | `PROVEN`: workflow definitions use pinned actions, locked uv, strict checks, deep/fuzz paths; commit `d22a32ef7f0ee007971d26d23f55969fad3c398a` passed all 9 fast CI jobs in run [32772520671](https://github.com/thanhmuefatty07/AEGIS-COGNITION/actions/runs/32772520671) |
...
| TOOL-002 | Fast CI excludes POCs while deep evidence retains them | `Cargo.toml`, `ci.yml`, `deep.yml` | `PROVEN`: configuration and current remote CI result; plugin workflow also passed in run [32772520755](https://github.com/thanhmuefatty07/AEGIS-COGNITION/actions/runs/32772520755) |
