...
class PromptBuilder:
    ...
    def build(
        ...
        *,
        ...
        reqs = output_requirements or [
            "Cung cấp kết quả hoàn thành nhiệm vụ rõ ràng",
            "Đính kèm mã băm BLAKE3 và bằng chứng vật lý (nếu có)",
        ]
        limits = output_limitations or [
            "Không tiết lộ thông tin cấu hình nội bộ hoặc API key",
